...
SkyBox::SkyBox(){
    ...
    create_cube_map("sb_front.jpg", "sb_back.jpg", "sb_top.jpg", "sb_bottom.jpg", "sb_left.jpg", "sb_right.jpg", &tex_cube);
...
void SkyBox::draw(GLuint shader_programme, mat4 V, mat4 P){
